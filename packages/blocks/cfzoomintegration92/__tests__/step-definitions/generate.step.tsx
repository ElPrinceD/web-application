...
// import generateSignature, {generateVideoSignature} from '../../src/GenerateSignature'; // REMOVED: Using server-side generation for security
...
defineFeature(feature, (test) => {
  ...
  // Test disabled - signature generation moved to server-side for security
