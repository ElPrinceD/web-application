...
const feature = loadFeature("./__tests__/features/EmailAccountRegistration-scenario.feature");
...
defineFeature(feature, (test) => {
    ...
    test("Invalid Email", ({ given, when, then }) => {
        ...
        when("I Register with an Invalid Email", () => {
            ...
            msgPlayloadAPI.addData(getName(MessageEnum.AuthTokenDataMessage), "USER-TOKEN");
            runEngine.sendMessage("Unit Test", msgPlayloadAPI)   
            instance.setState({firstName: "FIRST", lastName: "LAST", email: "example@gmail.com", password: "pass", reTypePassword: "pass"});
    ...
    test("Invalid Password", ({ given, when, then }) => {
        ...
        when("I Register with an Invalid Password", () => {
            ...
            msgPlayloadAPI.addData(getName(MessageEnum.AuthTokenDataMessage), "USER-TOKEN");
            runEngine.sendMessage("Unit Test", msgPlayloadAPI)   
            instance.setState({firstName: "FIRST", lastName: "LAST", email: "example@gmail.com", password: "pass", reTypePassword: "pass123"});
        });
    ...
    test("Password and RePassword do not match", ({ given, when, then }) => {
        ...
        when("I Register with Password and RePassword that do not match", () => {
            instance = emailAccountRegistrationWrapperRegistration.instance() as EmailAccountRegistration 
            instance.setState({firstName: "FIRST", lastName: "LAST", email: "example@gmail.com", password: "password123!!", reTypePassword: "pass123"});
    ...
    test("Valid Registration", ({ given, when, then }) => {
        ...
        when("I Register with all valid data", () => {
            instance = emailAccountRegistrationWrapperRegistration.instance() as EmailAccountRegistration 
            instance.setState({firstName: "FIRST", lastName: "LAST", email: "example@gmail.com", password: "password123!!", reTypePassword: "password123!!"});
        });
